...
# 01_setup.sh
#
# Here's the basics of 01_setup.md turned into a script.

# I made one significant change not recorded elsewhere in the documentation.
# In ${df_ds_sysconfig}, I added these variables for my local lead user.
...
# to wipe the 389-DS database cleanly, and restore it to an initial state.
#
...
#cn: cn=Directory Administrators,${s_basedn}
#changetype: modify
#add: uniqueMember
